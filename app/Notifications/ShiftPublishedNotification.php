...
class ShiftPublishedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $mail = new MailMessage()
            ...
            ->line(
                "Vaktir þínar hafa verið birtar. Hér eru komandi vaktirnar þínar:",
            )
            ->line("");
        ...
        foreach ($sorted as $assignment) {
            ...
            $mail->line(
                "📅 **{$date}** — {$assignment->shift->title} ({$start}–{$end})",
            );
        }
        ...
        $mail
            ...
            ->line(
                "Vinsamlegast hafðu samband við yfirmann þinn ef eitthvað er rangt.",
            )
